                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url('post/edit/' . $post->id) ?>" class="btn btn-sm btn-primary">E</a>
                                            <a href="<?php echo base_url('post/delete/' . $post->id) ?>" class="btn btn-sm btn-danger">H</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
